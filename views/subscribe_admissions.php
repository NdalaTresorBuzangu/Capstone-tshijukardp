...
$stmt = $conn->prepare("SELECT subscribeID FROM Subscribe WHERE userID = ? AND roleType='Admissions Office' LIMIT 1");
    ...
    <form method="POST">
        ...
        <div class="mb-3 form-check">
            ...
            <label class="form-check-label" for="accept_terms_subscribe">
                I have read and accept the <a href="../index.php?controller=Page&action=terms" target="_blank" rel="noopener">Terms of Service</a> and <a href="../index.php?controller=Page&action=privacy" target="_blank" rel="noopener">Privacy Policy</a>. I consent to the processing of my data (GDPR / Ghana data protection).
            </label>
        </div>
